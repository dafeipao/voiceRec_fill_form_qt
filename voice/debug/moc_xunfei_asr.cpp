/****************************************************************************
** Meta object code from reading C++ file 'xunfei_asr.h'
**
...
#error "The header file 'xunfei_asr.h' doesn't include <QObject>."
...
void XunfeiASR::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &XunfeiASR::resultReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void XunfeiASR::resultReceived(const QString & _t1)
{
